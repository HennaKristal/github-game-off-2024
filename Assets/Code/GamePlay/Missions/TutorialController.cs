...
public class TutorialController : MonoBehaviour
{
    ...
    private void FinishMission()
    {
        GameManager.Instance.AddNewNotification(
            "Welcome in!",
            "Secret Sanctum",
            "TODO: Great to have you with us! Now that you have proven yourself let me officially invote you to our ransk.We have granted you your furst badge of honor, please check your badges and wear it proudly.Once you are ready, meet me at the command sector and we will assign your next task for you."
        );
